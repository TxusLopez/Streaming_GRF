...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 30 17:20:44 2019
...
class GRF_HoeffdingAdaptiveTree(HoeffdingTree):
            ...
            # Condition to replace alternate tree
                ...
                if self.get_error_width() > error_width_threshold \
                    ...
                    if bound < (old_error_rate - alt_error_rate):
                        ...
                        if isinstance(self._alternate_tree, GRF_HoeffdingAdaptiveTree.ActiveLearningNode):
                            self._alternate_tree = None
                        elif isinstance(self._alternate_tree, GRF_HoeffdingAdaptiveTree.InactiveLearningNode):
                            self._alternate_tree = None
                        else:
        ...
        def kill_tree_children(self, hat):
            for child in self._children:
                if child is not None:
                    ...
                    if isinstance(child, GRF_HoeffdingAdaptiveTree.AdaSplitNode) and child._alternate_tree is not None:
                    ...
                    if isinstance(child, GRF_HoeffdingAdaptiveTree.ActiveLearningNode):
                        child = None
                        hat._active_leaf_node_cnt -= 1
                    elif isinstance(child, GRF_HoeffdingAdaptiveTree.InactiveLearningNode):
                        child = None
    ...
    def __init__(self,
        ...
        super(GRF_HoeffdingAdaptiveTree, self).__init__(max_byte_size=max_byte_size,
