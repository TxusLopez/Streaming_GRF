...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb  4 11:35:19 2019
...
class GRF_MLPClassifier(BaseMultilayerPerceptron, ClassifierMixin):
    ...
    def __init__(self, hidden_layer_sizes=(100,), activation="relu",
                 ...
                 epsilon=1e-8, n_iter_no_change=10,min_max_data=[],gamma=0.0,n_gaussianRF=0,time_coding=1.0):
        
        sup = super(GRF_MLPClassifier, self)
    ...
    def _partial_fit(self, X, y, classes=None):
        ...
        super(GRF_MLPClassifier, self)._partial_fit(X, y)
